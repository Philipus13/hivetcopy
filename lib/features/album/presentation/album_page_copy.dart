...
import 'package:hivet/features/album/presentation/poster_tile_copy.dart';

class AlbumPageCopy extends StatefulWidget {
  final int mode;
  const AlbumPageCopy({
    Key? key,
    required this.mode,
...
class _AlbumPageState extends State<AlbumPageCopy> {
        ...
        if (state is AlbumFailure) {
          return Center(
            child: Text(
              ...
              // style: TextStyle(color: instance.colorScheme.primary),
          ...
          return GridView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              return index >= state.album.length
                  ? BottomLoader()
                  : PosterTileCopy(albumResponse: state.album[index]);
            },
